...
const PostUpdatePage = () => {
  ...
  const handleSubmit = async (
    ...
    const data = await updatePostDetail.mutateAsync({
      body: {
        DCMNCODE: "INPSALEPOST",
        HEADER: [
          {
    ...
    if (values.newImage != null || contentInitial != value) {
      ...
      if (values.newImage != null) {
        ...
        await deleteImageThumnail.mutateAsync({ body: formData1 });
      ...
      setImageThumnail.mutateAsync({ body: formData });
    }
        ...
        <DialogContent className="sm:max-w-[425px]">
          <DialogHeader>
            ...
            <div className="w-full overflow-hidden">
              <div
                className={`${
                  getDetailPost.isSuccess ? "-translate-x-1/2" : "translate-x-0"
                      ...
                      <img
                        src={
                          values.newImage
                            ...
                            : getImageThumnail.data
                            ? URL.createObjectURL(getImageThumnail.data)
